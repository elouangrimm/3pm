    ...
    return (function () {
        ...
        1: [function (require, module, exports) {
            ...
            function findPeaks(data) {
                var peaks = [];
                // --- MODIFICATION 1: Changed initial threshold from 0.9 to 0.8 ---
                var threshold = .8;
                // --- MODIFICATION 2: Changed minimum threshold from 0.3 to 0.25 ---
                var minThresold = .25;
                var minPeaks = 15;
            ...
            function identifyIntervals(peaks) {
                ...
                peaks.forEach(function (peak, index) {
                    ...
                    for (var i = 1; i < 10; i += 1) { // Changed loop to start from 1 to avoid 0 interval
                        if (peaks[index+i]) {
                           _loop(i)
                        }
                    }
